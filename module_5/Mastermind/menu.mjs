...
export class TMenu {
  ...
  constructor(aSpriteCanvas) {
    ...
    this.#roundNumber = 1;
    this.#buttonNewGame = new libSprite.TSpriteButtonHaptic(
      aSpriteCanvas,
      SpriteInfoList.ButtonNewGame,
      MastermindBoard.ButtonNewGame
    );

    this.#buttonCheckAnswer = new libSprite.TSpriteButtonHaptic(
      aSpriteCanvas,
      SpriteInfoList.ButtonCheckAnswer,
      MastermindBoard.ButtonCheckAnswer
    );

    this.#buttonCheat = new libSprite.TSpriteButtonHaptic(
      aSpriteCanvas,
      SpriteInfoList.ButtonCheat,
      MastermindBoard.ButtonCheat
    );

    this.#panelCheat = new libSprite.TSprite(
      aSpriteCanvas,
