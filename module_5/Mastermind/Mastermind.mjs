...
export function newGame() {
  // Remove all existing color pickers
  ...
  console.log("Snap positions after reset:", GameProps.snapTo.positions);

  // Move the round indicator
  moveRoundIndicator();
